...
import { ShoppingBasket, Sprout, Apple, Leaf } from 'lucide-react';
...
const DecorativePanel = () => (
  // This component's display is controlled by its parent's 'hidden md:block' class.
  // The content inside here is already designed to be responsive within its container.
  <div
    className="hidden md:flex flex-col items-center justify-center w-full h-full bg-gradient-to-br from-green-600 to-green-700 p-8 relative overflow-hidden"

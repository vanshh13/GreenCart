...
//       res.json(order);
//     } catch (error) {
//       console.error("Error creating Razorpay order:", error); // Log full error
...
//     const razorpay = new Razorpay({
//         key_id: process.env.RAZORPAY_KEY || "rzp_test_90ZGyZNVzzFKRH",
//         key_secret: process.env.RAZORPAY_SECRET || "71W2BO6yJp5w5zwcOmStw8YX"
//     });
